...
namespace Formular {
    ...
    function handleChange(_event: Event): void {
        ...
        if (target.name == "radioPutzhilfe") {
            ...
            for (let i: number = 0; i < data["Putzhilfe"].length; i++) {
                let dom: HTMLElement = document.getElementById("Putzhilfe" + i);
        ...
        if (target.name == "radioGeld") {
            Geldboolean = true;
            for (let i: number = 0; i < data["Geld abheben"].length; i++) {
                let dom: HTMLElement = document.getElementById("Geld abheben" + i);
                dom.setAttribute("value", "off");
            }
            target.setAttribute("value", "on");
        }
        ...
        if (target.name == "radioLieferung") {
            ...
            for (let i: number = 0; i < data["Lieferung"].length; i++) {
                let dom: HTMLElement = document.getElementById("Lieferung" + i);
                dom.setAttribute("value", "off");
            }
            target.setAttribute("value", "on");
        }
   ...
   let Putzhilfeboolean: boolean = true;
   let Geldboolean: boolean = true;
   let Lieferungboolean: boolean = true;
